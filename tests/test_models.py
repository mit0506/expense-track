...
def test_user_profile_init():
    user = UserProfile(username="test", password_hash="hash", name="Test", monthly_income=1000)
...
def test_subscription_init():
    sub = Subscription(user_id=1, merchant="Netflix", amount=15.99, next_billing_date="2026-06-01")
